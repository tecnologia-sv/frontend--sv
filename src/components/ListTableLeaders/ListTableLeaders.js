    ...
    <>
      <div className={tableStyles["search-line"]}>
        ...
        <div className={tableStyles["search-line-col2"]}>
          ...
          />
          <ExportToExcelButton dataset={leaderData} />
        </div>
      </div>

      <div className={tableStyles["info-title"]}>Líderes de zona</div>
      <div className={tableStyles["table-container"]}>
        <table {...getTableProps()} className={tableStyles["leaders-table"]}>
          <thead>
            ...
            {page.map((row, i) => {
              ...
              return (
                <tr {...row.getRowProps()}>
                  ...
                  <td>
                    <UpdateLeaderButton id={row.cells[0].value} />
      ...
      <div className={tableStyles["table-footer"]}>
        <div className={tableStyles["table-footer-col1"]}>
          Página <span>{pageIndex + 1}</span> de{" "}
