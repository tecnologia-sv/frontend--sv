...
import tableStyles from "./GenericTable.module.css";

const GenericTable = (props) => {
  const { dataset, Headers, pageSize, actions, identifier, downloadFileName } =
    props;
        ...
        <table className={tableStyles["clients-table"]}>
          <thead>
            <tr>
              ...
              {actions && (
                <th className={tableStyles["clients-th"]}>Acciones</th>
              )}
            </tr>
          </thead>
          <tbody>
